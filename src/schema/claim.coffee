    ...
    claimant:
      ...
      oneOf: [
        ...
        ,
          ...
          properties:
            template:
              description: "A dictionary of URL template parameters and their values. These bind to the URL template specified in the grant. The resultant URL must respond with the claimant's public signature key matching this claim."
              type: "object"
      ]
