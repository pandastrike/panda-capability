schema =
  ...
  properties:
    ...
    revocations:
      description: "Optional. List that describes the issuer's revocation authorities. When a issuing a grant, these authorities give the issuer the power to revoke the grant without rotating their primary signature key. The grant is co-signed with these authorities (alongside the issuer's authority). Each may be one of: a key literal, a URL reference."
      type: "array"
      minItems: 1
      items:
        oneOf: [
